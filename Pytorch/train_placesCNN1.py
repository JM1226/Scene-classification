...
class MyDataset(Dataset):
    def __init__(self, json, transform=None, target_transform=None, loader=default_loader):
        f=open('scene_train_annotations_20170904.json','r')
		imgs=[]
		f=json.load(f)
		for line in f:
			imgs.append((os.path.join('/home/gpu2/wx/competition/data/train/scene_train_images_20170904',line['image_id']),int(line['label_id'])))
        self.imgs = imgs
...
train_loader=MyDataset(json='scene_train_annotations_20170904.json', transforms.Compose([
